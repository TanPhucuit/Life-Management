    ...
    <aside className="desktop-v2-sidebar fixed inset-y-0 left-0 z-50 w-[248px] border-r border-[var(--border)] bg-[color-mix(in_srgb,var(--glass-strong)_92%,var(--background))] p-4 shadow-[12px_0_48px_rgba(0,0,0,.08)] backdrop-blur-3xl">
      <div className="flex h-full min-h-0 flex-col">
        <button
          ...
          className="desktop-v2-brand flex min-h-[58px] w-full items-center gap-3 rounded-2xl px-3 text-left transition-colors duration-150 hover:bg-[var(--surface-soft)]"
        ...
        >
          ...
          <span className="desktop-v2-sidebar-copy min-w-0">
        ...
        <div className="mt-auto space-y-2 pt-5">
          ...
          <div className="desktop-v2-account flex items-center gap-2 rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-2.5 shadow-[var(--shadow-sm)]">
            <Link
              href="/settings"
              onClick={(event) => {
                event.preventDefault();
              ...
              className="desktop-v2-account-link flex min-w-0 flex-1 items-center gap-2.5 rounded-xl p-1"
            ...
            >
              ...
              <span className="desktop-v2-account-copy min-w-0">
...
function SidebarNavItem({
  ...
  return (
    <Link
      ...
      className={`desktop-v2-nav-item group relative flex min-h-11 items-center gap-3 overflow-hidden rounded-xl px-3 text-sm font-medium transition-colors duration-150 ${
        active
          ? 'text-[var(--foreground)]'
    ...
    >
      ...
      />
      <span className="desktop-v2-nav-label relative truncate">{item.label}</span>
    </Link>
  );
}
...
function SidebarUtilityLink({
  ...
  return (
    <Link
      ...
      title={label}
      aria-current={active ? 'page' : undefined}
      className={`desktop-v2-nav-item relative flex min-h-11 items-center gap-3 rounded-xl px-3 text-sm font-medium transition-colors duration-150 ${
        active
    ...
    >
      ...
      <span className="desktop-v2-nav-label">{label}</span>
    </Link>
  );
}
